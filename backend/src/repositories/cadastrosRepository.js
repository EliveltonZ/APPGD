...
const ENTITY_MAP = {
  ...
  montadores:      { model: Montador,    pk: 'id',     field: 'name', extra: ['password', 'regime', 'ativo'] },
  vendedores:      { model: Vendedor,    pk: 'id',     field: 'name', extra: ['regime', 'ativo'] },
  liberadores:     { model: Liberador,   pk: 'id',     field: 'name', extra: ['regime', 'ativo'] },
