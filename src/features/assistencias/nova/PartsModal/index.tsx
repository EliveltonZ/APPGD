...
import type { ServicePart, PartFormData, PartSide, PartType } from '../../../../types/assistencia';
import {
  PART_SIDE_OPTIONS,
  PART_TYPE_OPTIONS,
  FAILURE_OPTIONS,
...
export function PartsModal({ isOpen, onClose, pecas, onAdd, onRemove }: PartsModalProps) {
      ...
      <div className="pm-form">
        ...
        <div className="frow--2">
          ...
          <Select
            label="Tipo"
            value={form.tipo}
            onChange={(e) => set('tipo', e.target.value as PartType | '')}
        ...
        <div className="as-modal-actions pm-form__actions">
          <button className="as-btn as-btn--ghost" onClick={handleClear} type="button">
            <RotateCcw size={13} />
            Limpar
          </button>
          <div style={{ flex: 1 }} />
          ...
          <button className="as-btn as-btn--primary" onClick={handleInsert} type="button">
            <Plus size={14} />
            Inserir Peça
          </button>
        </div>
