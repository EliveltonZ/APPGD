...
function buildExpedicaoPayloadFromForm() {
  ...
  return {
    ...
    p_conferido: Fields.get(SELECTORS.production.prontoId) ?? 0,
    p_motorista: Fields.get(SELECTORS.production.entregaId) ?? 0,
    ...
    p_embalagemresp: Fields.get(SELECTORS.embalagem.respId) ?? 0,
