...
const stats: StatCard[] = [
  { id: "pedidos",    label: "Pedidos Abertos",  value: "—", icon: ShoppingBag, accent: "var(--accent)"  },
  { id: "producao",   label: "Em Produção",       value: "—", icon: Factory,     accent: "#f97316"        },
  { id: "expedicao",  label: "Em Expedição",      value: "—", icon: Truck,       accent: "#16a34a"        },
  { id: "financeiro", label: "Valores Pendentes", value: "—", icon: DollarSign,  accent: "var(--accent2)" },
];
      ...
      <div className="dashboard">
        ...
        <div className="dashboard__area">
          <div className="dashboard__placeholder">
            <LayoutDashboard size={36} className="dashboard__placeholder-icon" />
