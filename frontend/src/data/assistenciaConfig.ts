...
// Maps PartType string key → p_ocorrencia smallint ID in the DB.
// Confirm these IDs match tblOcorrencias (or equivalent) in your database.
export const PART_TYPE_ID: Record<string, number> = {
  estrutural:     1,
  nao_estrutural: 2,
  acessorio:      3,
  terceiros:      4,
